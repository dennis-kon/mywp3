 ...
 * Slug: fashion-nook/hidden-empty-mini-cart
 * Inserter: no
 */
...
<div class="wp-block-woocommerce-empty-mini-cart-contents-block">
	...
	<p class="has-text-align-center has-medium-font-size" style="font-style:normal;font-weight:500"><?php esc_html_e('Your basket is currently empty!', 'fashion-nook');?></p>
	<!-- /wp:paragraph -->
