	...
	<div class="wp-block-woocommerce-product-collection">
		...
		<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--40)">
			...
			<div class="wp-block-group">
				...
				<h2 class="wp-block-heading has-medium-font-size"><?php esc_html_e('Pairs well with', 'fashion-nook');?></h2>
				<!-- /wp:heading -->
			...
			<!-- wp:woocommerce/product-template {"layout":{"type":"flex","justifyContent":"left","verticalAlignment":"top","flexWrap":"nowrap","orientation":"horizontal"}} -->
				<!-- wp:woocommerce/product-image {"showSaleBadge":false,"isDescendentOfQueryLoop":true,"style":{"dimensions":{"aspectRatio":"1"}}} -->
					<!-- wp:woocommerce/product-sale-badge {"align":"left","style":{"spacing":{"margin":{"top":"3%","bottom":"3%","left":"3%","right":"3%"}}}} /-->
				...
				<!-- wp:woocommerce/product-price {"isDescendentOfQueryLoop":true,"style":{"spacing":{"margin":{"top":"0.625rem","bottom":"0"}}}} /-->
