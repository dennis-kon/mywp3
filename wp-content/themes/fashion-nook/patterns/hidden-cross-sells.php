...
/**
 * Title: Cross Sells
 * Slug: fashion-nook/hidden-cross-sells
 * Inserter: no
 */
declare( strict_types = 1 );
?>

<!-- wp:group {"metadata":{"name":"Cross Sells","patternName":"fashion-nook/hidden-cross-sells"},"align":"wide","className":"is-style-default","style":{"spacing":{"blockGap":"0","margin":{"top":"0","bottom":"0"}}},"layout":{"type":"default"}} -->
	...
	<div class="wp-block-woocommerce-product-collection">
		...
		<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--40)">
			...
			<div class="wp-block-group">
				...
				<h2 class="wp-block-heading has-medium-font-size"><?php esc_html_e('You might like', 'fashion-nook');?></h2>
				<!-- /wp:heading -->
